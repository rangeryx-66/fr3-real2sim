...
R=Path(__file__).resolve().parents[1];O=R/'results/fr3_payload_capture_recovery';O.mkdir(exist_ok=True)
objects=[('raisin',[1007,1005,1006,1008,1009]),('sugar',list(range(1026,1030))+[1025]),('mug',list(range(1035,1040))),('banana',list(range(1020,1025)))]
