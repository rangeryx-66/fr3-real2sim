"""Export geometry for a preregistered family-expansion validation pool.
...
CANDIDATES = [
    "vomp/plate_large/plate_large",
    "vomp/plate_small/plate_small",
    "vomp/serving_bowl/serving_bowl",
    "vomp/bin_a06/bin_a06",
    "vomp/bin_b03/bin_b03",
    "vomp/plasticpail_a02/plasticpail_a02",
    "handal/measuring_cups",
    "handal/measuring_spoon",
    "hot3d/pitcher",
    "hot3d/coffee_pot",
    "objaverse/gregorys_coffee_cup",
    "ycb/pitcher",
    "vomp/utilityjug_a01/utilityjug_a01",
    "hot3d/storage_box",
]
